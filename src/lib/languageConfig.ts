...
// Storage keys
const LANGUAGE_KEY = "rayos:language";
const LANGUAGE_INITIALIZED_KEY = "rayos:language-initialized";
const LEGACY_LANGUAGE_KEY = "rayos_language";
const LEGACY_LANGUAGE_INITIALIZED_KEY = "rayos_language_initialized";
