      ...
      >
        ...
        >
          {currentTheme === "system7" ? (
            /* System 7 info bar: "X items  X MB in disk  X MB available" */
            <div className="flex items-center justify-between px-3 py-1 bg-white border-b-2 border-black font-os-ui text-[13px]">
              <span>
                {sortedFiles.length}{" "}
              ...
              <span>
                {Math.round((storageSpace.available / 1024 / 1024) * 10) / 10} MB in disk
              </span>
              <span>
