...
interface AppStoreState {
  ...
  // RayOS version (fetched from version.json)
  rayOSVersion: string | null;
  rayOSBuildNumber: string | null;
  rayOSBuildTime: string | null;
  setRayOSVersion: (version: string, buildNumber: string, buildTime?: string) => void;
...
const createUseAppStore = () =>
  create<AppStoreState>()(
    persist(
      ...
      // RayOS version (fetched from version.json)
      rayOSVersion: null,
      rayOSBuildNumber: null,
      rayOSBuildTime: null,
      setRayOSVersion: (version, buildNumber, buildTime) =>
        set({
          rayOSVersion: version,
          rayOSBuildNumber: buildNumber,
          rayOSBuildTime: buildTime || null,
        }),
      ...
      }),
      {
        ...
        rayOSBuildTime: state.rayOSBuildTime,
